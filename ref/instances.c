...
const char* faest_get_param_name(faest_paramid_t paramid) {
  ...
  case FAEST_LYNX_128S:
    return "FAEST_LYNX_128S";
  case FAEST_LYNX_128F:
    return "FAEST_LYNX_128F";
  case FAEST_LYNX_192S:
    return "FAEST_LYNX_192S";
  case FAEST_LYNX_192F:
    return "FAEST_LYNX_192F";
  case FAEST_LYNX_256S:
    return "FAEST_LYNX_256S";
  case FAEST_LYNX_256F:
    return "FAEST_LYNX_256F";
  case FAEST_LYNX_384S:
    return "FAEST_LYNX_384S";
  case FAEST_LYNX_384F:
    return "FAEST_LYNX_384F";
  case FAEST_LYNX_512S:
    return "FAEST_LYNX_512S";
  case FAEST_LYNX_512F:
    return "FAEST_LYNX_512F";
  default:
...
#define FAEST_LYNX_128S_PARAMS PARAMS(FAEST_LYNX_128S)
#define FAEST_LYNX_128F_PARAMS PARAMS(FAEST_LYNX_128F)
#define FAEST_LYNX_192S_PARAMS PARAMS(FAEST_LYNX_192S)
#define FAEST_LYNX_192F_PARAMS PARAMS(FAEST_LYNX_192F)
#define FAEST_LYNX_256S_PARAMS PARAMS(FAEST_LYNX_256S)
#define FAEST_LYNX_256F_PARAMS PARAMS(FAEST_LYNX_256F)
#define FAEST_LYNX_384S_PARAMS PARAMS(FAEST_LYNX_384S)
#define FAEST_LYNX_384F_PARAMS PARAMS(FAEST_LYNX_384F)
#define FAEST_LYNX_512S_PARAMS PARAMS(FAEST_LYNX_512S)
#define FAEST_LYNX_512F_PARAMS PARAMS(FAEST_LYNX_512F)
...
const faest_paramset_t* faest_get_paramset(faest_paramid_t paramid) {
  switch (paramid) {
    ...
    CASE_PARAM(FAEST_LYNX_128S)
    CASE_PARAM(FAEST_LYNX_128F)
    CASE_PARAM(FAEST_LYNX_192S)
    CASE_PARAM(FAEST_LYNX_192F)
    CASE_PARAM(FAEST_LYNX_256S)
    CASE_PARAM(FAEST_LYNX_256F)
    CASE_PARAM(FAEST_LYNX_384S)
    CASE_PARAM(FAEST_LYNX_384F)
    CASE_PARAM(FAEST_LYNX_512S)
    CASE_PARAM(FAEST_LYNX_512F)
  default:
    return NULL;
  }
}
